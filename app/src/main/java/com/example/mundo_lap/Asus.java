...
public class Asus extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mDatabase.child("Marcas").child("Asus").child("001").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mDatabase.child("Marcas").child("Asus").child("002").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
        ...
        mDatabase.child("Marcas").child("Asus").child("003").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
        ...
        mDatabase.child("Marcas").child("Asus").child("004").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
        ...
        mDatabase.child("Marcas").child("Asus").child("005").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
        ...
        mDatabase.child("Marcas").child("Asus").child("006").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
        ...
        mDatabase.child("Marcas").child("Asus").child("007").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
        ...
        mDatabase.child("Marcas").child("Asus").child("008").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
        ...
        mDatabase.child("Marcas").child("Asus").child("009").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
        ...
        mDatabase.child("Marcas").child("Asus").child("010").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    String mast = dataSnapshot.child("modelo").getValue().toString();
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("001").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0111"); //item cambia
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("002").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0222"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("003").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0333"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("004").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0444"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("005").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0555"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("006").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0656"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("007").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0777"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("008").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0888"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("009").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("0999"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("Asus").child("010").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("1000"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
