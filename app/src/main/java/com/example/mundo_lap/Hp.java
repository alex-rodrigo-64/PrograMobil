            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("001").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("11111"); //item cambia
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("002").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("22222"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("003").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("33333"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("004").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("44444"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("005").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("55555"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("006").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("66666"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("007").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("77777"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("008").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("88888"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("009").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("99999"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Marcas").child("HP").child("010").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteristicas").getValue().toString();
                        mDatabase = database.getReference("Users").child(id).child("Favoritos").child("100000"); //item cambia
                        //Toast.makeText(getActivity(),id,Toast.LENGTH_SHORT).show();
                        mDatabase.child("caracteristicas").setValue(caracteristicas);
                        mDatabase.child("imagen").setValue(imagen);
                        mDatabase.child("modelo").setValue(modelo);
