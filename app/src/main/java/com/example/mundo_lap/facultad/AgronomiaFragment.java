...
public class AgronomiaFragment extends Fragment {

    DatabaseReference mDatabase;
    FirebaseAuth mAuth;
    FirebaseDatabase database;
    String id;
    String facultad = "Agronomia";
    Button back;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_agronomia,container,false);
        ...
        descripcion2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mDatabase.child("Facultades").child(facultad).child("002").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            String mast = dataSnapshot.child("caracteisticas").getValue().toString();
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Facultades").child(facultad).child("002").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String precio = dataSnapshot.child("precio").getValue().toString();
                        String imagen = dataSnapshot.child("imagen").getValue().toString();
                        String caracteristicas = dataSnapshot.child("caracteisticas").getValue().toString();
